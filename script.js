    ...
    start.on("click", function (e) {
        ...
        $.ajax({
           ...
           method: "GET"
            ...
            day1.text("day : " + data.list[0].dt_txt)
            day2.text("day : " + data.list[8].dt_txt)
            day3.text("day : " + data.list[16].dt_txt)
            day4.text("day : " + data.list[24].dt_txt)
            day5.text("day : " + data.list[32].dt_txt)
             
            tem1.text("tempurature : " + data.list[0].main.temp)
            ...
            hum1.text("humidity : " + data.list[0].main.humidity)
